...
if __name__ == '__main__':
    ...
    dest_dir = root.parent / 'results' / '13_Feature_of_interactionDomain_Feature1_boxPlot_of_DomainSize_WT_andHS_hypothesisTest'
    ...
    for num_pair in num_list:
        ...
        df = pd.DataFrame(
            {'WT': WT_domain_size, 'HS': HS_domain_size_filter})
        print(df)
