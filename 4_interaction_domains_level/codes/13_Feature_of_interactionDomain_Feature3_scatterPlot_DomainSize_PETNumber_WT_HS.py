...
if __name__ == '__main__':
    ...
    dest_dir = root.parent / 'results' / '13_Feature_of_interactionDomain_Feature3_scatterPlot_DomainSize_PETNumber_WT_HS'
    ...
    for group in group_list:
        ...
        #     ax.scatter((domains_addSzie['size'] / 1000), (domains_addSzie['PET_number'] / 1000), s=1.5, color=color, alpha=0.7)
        # #
            ax.scatter(np.log10(domains_addSzie['size'] / 1000), np.log10(domains_addSzie['PET_number']), s=2.5, color=color, alpha=0.7)
        ax.set_xticks([2, 3])
