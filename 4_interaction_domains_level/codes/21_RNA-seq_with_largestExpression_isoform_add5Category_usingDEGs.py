...
if __name__ == '__main__':
    ...
    #     print(UCSC_ref_addLabel_addType_Chrolist_addCategory.head())
        ...
        # print(genes.shape)
        # print(genes.head(50))
        expressed_raw = genes[(genes['type'] == 'down_regulated') | (genes['type'] == 'up_regulated')]
        ...
        print('p_appear', round(p_appear,2))
        ...
        print('p_disappear', round(p_disappear,2))
