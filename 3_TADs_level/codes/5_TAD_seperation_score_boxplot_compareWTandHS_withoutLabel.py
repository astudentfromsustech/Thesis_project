...
if __name__ == '__main__':
    ...
    for group in groups:
        ...
        dest_dir = root.parent / 'results' / 'home_data_results' / f'5_TAD_seperation_score_boxplot_withDots_jitter_withoutLabel'
        ...
        for chro in chro_list:
            ...
            # plt.show()
            plt.savefig(dest_dir / f'{name}_{chro}_WT_HS_mannwhitneyu_pvalue_{p_val}_10k_withoutLabel.png', dpi=300, bbox_inches='tight')
