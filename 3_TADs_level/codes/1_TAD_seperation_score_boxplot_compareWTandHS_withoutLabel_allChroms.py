...
if __name__ == '__main__':
    ...
    dest_dir = root.parent / 'results' / f'1_TAD_seperation_score_boxplot_withDots_jitter_withoutLabel_allChroms'
    ...
    for chro in chro_list:
        ...
        WT_IS = pd.read_csv(WT_src_dir / f'WT_me3_ac_boundaries.bed', header=None, sep='\t')
        ...
        HS_IS = pd.read_csv(HS_src_dir / f'HS_me3_ac_boundaries.bed', header=None, sep='\t')
