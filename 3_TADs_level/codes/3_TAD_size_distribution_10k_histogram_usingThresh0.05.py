...
if __name__ == '__main__':
    ...
    dest_dir = root.parent / 'results' / 'home_data_results' / '3_results_TAD_size_distribution_withLabel_usingThresh0.05'
    # dest_dir = root.parent / 'results' / 'home_data_results' / '3_results_TAD_size_distribution_withoutLabel_usingThresh0.05'
    ...
    src_dir = root.parent / 'results' / 'home_data_results' / f'CDS0{WT_num}D_combined_10000_targetChroms_normalize0_1_correctionKR_min30k_max100k_step10k_thresh0.05_delta0.01_dfr'
    WT_TAD_raw = pd.read_csv(src_dir / f'CDS0{WT_num}D_thresh0.05_delta0.01_domains.bedpe', header=None, sep='\t')
    ...
    HS_num = '08'
    HS_color = '#99BDCB'
    src_dir = root.parent / 'results' / 'home_data_results' / f'CDS0{HS_num}D_combined_10000_targetChroms_normalize0_1_correctionKR_min30k_max100k_step10k_thresh0.05_delta0.01_dfr'
    HS_TAD_raw = pd.read_csv(src_dir / f'CDS0{HS_num}D_thresh0.05_delta0.01_domains.bedpe', header=None, sep='\t')
    ...
    ax.set_ylabel('')
    # plt.show()
    # fig.savefig(dest_dir / f'{WT_num}_{HS_num}_histogram_TAD_size_withLabel_Thresh0.05.png', dpi=300, bbox_inches='tight')
    fig.savefig(dest_dir / f'{WT_num}_{HS_num}_histogram_TAD_size_withoutLabel_Thresh0.05.png', dpi=300, bbox_inches='tight')