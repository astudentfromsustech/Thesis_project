...
def calculate_promoter(row, promoter_length=-1000):
    if row['strand'] == '+':
        return row['start'], row['start'] - promoter_length
    else:
        return row['end'] + promoter_length, row['end']
...
if __name__ == '__main__':
    ...
    result_arrange_addPromoter_sortedChroms.to_csv(src_dir / '8_step1_expressed_genes_allInfo_includingPromoter_sortedByChrom_promoterLen_minus1k.txt', index=None, sep='\t')
