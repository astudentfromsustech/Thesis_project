...
from scipy.stats import pearsonr, spearmanr, gaussian_kde, ks_2samp
...
if __name__ == '__main__':
    ...
    for chro in chro_list:
        ...
        dest_dir = root.parent / 'results' / 'home_data_results' / f'1_results_ScatterPlot_withColorDensity_of_IS_forCDS_data_withoutLabel'
    ...
    ks_statistic, p_value = ks_2samp(combined_result['score_x'], combined_result['score_y'])
