...
if __name__ == '__main__':
    ...
    dest_dir = root.parent / 'results' / '2_TAD_size_distribution_10k_histogram_for_ac_me3'
    ...
    HS_TAD_raw = pd.read_csv(src_dir / f'ac_me3_downsample_{HS_num}_me3_ac_combined_res10000_domains.bedpe', header=None, sep='\t')
