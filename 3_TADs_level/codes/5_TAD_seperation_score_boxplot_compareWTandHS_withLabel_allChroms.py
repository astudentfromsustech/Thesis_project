...
if __name__ == '__main__':
    ...
    for group in groups:
        ...
        dest_dir = root.parent / 'results' / 'home_data_results' / f'5_TAD_seperation_score_boxplot_withDots_jitter_withLabel_allChroms'
        ...
        # plt.show()
        plt.savefig(dest_dir / f'{name}_allChroms_WT_HS_mannwhitneyu_pvalue_{p_val:.2f}_10k_withLabel_allChroms.png', dpi=300, bbox_inches='tight')
