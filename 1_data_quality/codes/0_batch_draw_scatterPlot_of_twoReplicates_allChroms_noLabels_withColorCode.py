...
if __name__ == '__main__':
    ...
    # dest_dir = root.parent / 'data' / 'result_0_scatterPlot_of_twoReplicates_allChroms_noLabels_chr2L'
    dest_dir = root.parent / 'results' / 'result_0_scatterPlot_of_twoReplicates_allChroms_noLabels_withColorCode'
    ...
    # groups = [ ['02', '11', 'H3K27me3_HS', '#98A246'], ['04', '13', 'H3K27ac_WT', '#F50CB8'],
    #           ['05', '14', 'H3K27ac_HS', '#743CA6'], ['07', '16', 'RNAPII_WT', '#1087F4'], ['08', '17', 'RNAPII_HS', '#99BDCB']]
    for group in groups:
        rep1 = group[0]
        rep2 = group[1]
