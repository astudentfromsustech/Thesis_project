...
if __name__ == '__main__':
    ...
    src_dir = root.parent / 'data' / '0_prepare_pairs_downsample_for_Pre'
    anno_dir = root.parent / 'annotations'
    dest_dir = root.parent / 'data' / '1_pairs_from_dm6_to_dm3'
    ...
    for condition in conditions:
        ...
        for pair_num in pair_nums:
            print(pair_num)
            df = pd.read_csv(src_dir / f'{condition}_combined_PNAS.pairs_dn{pair_num}.Pre', sep=' ', header=None, names=['strand1', 'chrom1', 'pos1', 'frag1', 'strand2', 'chrom2', 'pos2', 'frag2'])
            ...
            data_sorted.to_csv(dest_dir / f'{condition}_combined_PNAS.pairs_dn{pair_num}.sorted.Pre', index=None, header=None, sep=' ')
